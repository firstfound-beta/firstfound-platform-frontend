...
const dummyStartups = [
  {
    ...
    name: "TechNova",
    description:
      "TechNOVA delivers strategic insights into the application of cutting edge technology...",
    category: "Technology",
    isFeatured: true,
    ...
    <nav className="bg-[#f5e5d8] shadow-md sticky top-0 z-50 backdrop-blur-sm bg-opacity-95">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div
            className="hidden lg:flex relative items-center flex-1 max-w-md mx-8"
            ref={searchRef}
          >
            <Search
      ...
      {isMenuOpen && (
        <div className="md:hidden fixed inset-0 top-[120px] bg-[#f5e5d8] z-40 overflow-y-auto">
          <div className="px-4 py-6 space-y-4">
            ...
            <a
              href="https://startup-originn.vercel.app/register"
              target="_blank"
              rel="noopener noreferrer"
              onClick={handleNavClick}
              className="block text-[#6b3e26] text-lg font-medium hover:text-[#a0522d] hover:bg-[#e5d5c8] px-4 py-3 rounded-lg transition-all duration-300"
